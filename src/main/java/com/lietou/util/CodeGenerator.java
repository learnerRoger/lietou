...
public class CodeGenerator {
    public static void main(String[] args) {
        DataSourceConfig dataSourceConfig = new DataSourceConfig
                .Builder("jdbc:mysql://localhost:3306/hrm?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2b8", "root", "200206")
        ...
        GlobalConfig globalConfig = new GlobalConfig.Builder()
                ...
                .outputDir("D:\\4K\\backup\\hrm-master\\hrm\\src\\main\\java")  // 输出路径为当前项目的/src/main/java目录下
                .author("lietou")
        ...
        PackageConfig packageConfig = new PackageConfig.Builder()
                ...
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "D:\\4K\\backup\\hrm-master\\hrm\\src\\main\\mapper")) // 设置mapperXml生成路径
                .build();
